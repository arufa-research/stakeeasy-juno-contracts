...
async function run () {
  ...
  const staking_contract_info = await staking_contract.instantiate(
    {
      ...
      "dev_fee": 5000,  // 5%
      "epoch_period": 3600*24*4 + 2*60,  // 4 days + 2 mins in seconds
      "underlying_coin_denom": "ujuno",
      "unbonding_period": 3600*24*28 + 2*60, // 28 days + 2 mins in seconds
      "reward_denom": "ujuno",
    },
  ...
  const validator_list = [
    "junovaloper1jt9w26mpxxjsk63mvd4m2ynj0af09csl2wtj45",
    "junovaloper1xwazl8ftks4gn00y5x3c47auquc62ssuvynw64",
    "junovaloper19w2488ntfgpduzqq3sk4j5x387zynwkn6799ag",
    "junovaloper100sdeaen0zwjp8tt24sqxvxn43mza0yx8vsc27",
    "junovaloper1sjajx5z7gpzgpvzw5mzw55zd5w3gtfht43nlmv"
  ];
