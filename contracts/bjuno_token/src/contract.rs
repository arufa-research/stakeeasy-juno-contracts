...
mod tests {
    ...
    fn do_instantiate_with_minter(
        ...
        _do_instantiate(
            ...
            "juno13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string()
        )
    }
    ...
    mod instantiate {
        ...
        fn basic() {
            ...
            let instantiate_msg = InstantiateMsg {
                ...
                mint: None,
                marketing: None,
                reward_contract_addr: "juno13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string()
            };
            let info = mock_info("creator", &[]);
            let env = mockenv();
    ...
    fn no_one_mints_if_minter_unset() {
        let mut deps = mock_dependencies();
        do_instantiate(deps.as_mut(), &String::from("genesis"), Uint128::new(1234),"juno13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string());
    ...
    fn queries_work() {
        ...
        let expected = do_instantiate(deps.as_mut(), &addr1, amount1,"juno13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string());
    ...
    fn transfer() {
        ...
        do_instantiate(deps.as_mut(), &addr1, amount1,"juno13we0myxwzlpx8l5ark8elw5gj5d59dl6cjkzmt80c5q5cv5rt54qwgqmr6".to_string());
